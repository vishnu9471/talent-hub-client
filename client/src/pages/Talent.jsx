...
const Talent = () => {
  ...
  const getPlayableVideoUrl = (url) => {
    ...
    if (
      ...
      // Convert video to widely supported format:
  ...
  const handleVideoError = (e, originalUrl) => {
    console.error(
    ...
    // If transformed Cloudinary URL fails,
